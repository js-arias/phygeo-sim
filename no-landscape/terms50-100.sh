...
pgs sim -trees 50  -terms "50,100" -age "23,5" -lambda "100,1000" -o neogene-slow -name "neogene-slow" project.tab
pgs sim -trees 50  -terms "50,100" -age "23,5" -lambda "10,100" -o neogene-avg -name "neogene-avg" project.tab
pgs sim -trees 50  -terms "50,100" -age "23,5" -lambda "1,10" -o neogene-fast -name "neogene-fast" project.tab

pgs freq -i neogene-slow-particles.tab -o want-neogene-slow.tab project.tab 
pgs freq -i neogene-avg-particles.tab -o want-neogene-avg.tab project.tab 
pgs freq -i neogene-fast-particles.tab -o want-neogene-fast.tab project.tab 

pgs sim -trees 50  -terms "50,100" -age "66,23" -lambda "100,1000" -o paleogene-slow -name "paleogene-slow" project.tab
pgs sim -trees 50  -terms "50,100" -age "66,23" -lambda "10,100" -o paleogene-avg -name "paleogene-avg" project.tab
pgs sim -trees 50  -terms "50,100" -age "66,23" -lambda "1,10" -o paleogene-fast -name "paleogene-fast" project.tab

pgs freq -i paleogene-slow-particles.tab -o want-paleogene-slow.tab project.tab 
pgs freq -i paleogene-avg-particles.tab -o want-paleogene-avg.tab project.tab 
pgs freq -i paleogene-fast-particles.tab -o want-paleogene-fast.tab project.tab 

pgs sim -trees 50  -terms "50,100" -age "145,66" -lambda "100,1000" -o cretaceous-slow -name "cretaceous-slow" project.tab
pgs sim -trees 50  -terms "50,100" -age "145,66" -lambda "10,100" -o cretaceous-avg -name "cretaceous-avg" project.tab
pgs sim -trees 50  -terms "50,100" -age "145,66" -lambda "1,10" -o cretaceous-fast -name "cretaceous-fast" project.tab

pgs freq -i cretaceous-slow-particles.tab -o want-cretaceous-slow.tab project.tab 
pgs freq -i cretaceous-avg-particles.tab -o want-cretaceous-avg.tab project.tab 
pgs freq -i cretaceous-fast-particles.tab -o want-cretaceous-fast.tab project.tab 

pgs sim -trees 50  -terms "50,100" -age "201,145" -lambda "100,1000" -o jurassic-slow -name "jurassic-slow" project.tab
pgs sim -trees 50  -terms "50,100" -age "201,145" -lambda "10,100" -o jurassic-avg -name "jurassic-avg" project.tab
pgs sim -trees 50  -terms "50,100" -age "201,145" -lambda "1,10" -o jurassic-fast -name "jurassic-fast" project.tab

pgs freq -i jurassic-slow-particles.tab -o want-jurassic-slow.tab project.tab 
pgs freq -i jurassic-avg-particles.tab -o want-jurassic-avg.tab project.tab 
pgs freq -i jurassic-fast-particles.tab -o want-jurassic-fast.tab project.tab 

pgs sim -trees 50  -terms "50,100" -age "252,201" -lambda "100,1000" -o triassic-slow -name "triassic-slow" project.tab
pgs sim -trees 50  -terms "50,100" -age "252,201" -lambda "10,100" -o triassic-avg -name "triassic-avg" project.tab
pgs sim -trees 50  -terms "50,100" -age "252,201" -lambda "1,10" -o triassic-fast -name "triassic-fast" project.tab

pgs freq -i triassic-slow-particles.tab -o want-triassic-slow.tab project.tab 
pgs freq -i triassic-avg-particles.tab -o want-triassic-avg.tab project.tab 
pgs freq -i triassic-fast-particles.tab -o want-triassic-fast.tab project.tab 
